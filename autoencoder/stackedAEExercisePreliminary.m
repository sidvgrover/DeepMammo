function [acc] = stackedAEExercisePreliminary(train_data, train_labels, test_data, test_labels, inputSize, numClasses, hiddenSizeL1, hiddenSizeL2, sparsityParam, lambda, beta)    
